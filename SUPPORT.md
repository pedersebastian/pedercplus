...
Thanks for using pedercplus! Before filing an issue, there are a few
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/pedersebastian/pedercplus/issues/new).
...
requests](https://github.com/pedersebastian/pedercplus/issues) to make
