...
This outlines how to propose a change to pedercplus. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("pedersebastian/pedercplus", fork = TRUE)`.
...
Please note that the pedercplus project is released with a [Contributor
Code of
Conduct](https://pedersebastian.github.io/pedercplus/CODE_OF_CONDUCT.md).
